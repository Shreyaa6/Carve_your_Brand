  ...
  return (
    ...
    <main className="bg-background">
      <div className="wrapper relative">
        ...
        <section className="text-primary h-[100dvh] w-full bg-background grid place-content-center sticky top-0 z-10 border-b border-primary/5">
          ...
          <div className="text-center relative z-10 px-4">
            ...
            <h1 className="text-[12vw] lg:text-[8vw] font-serif font-medium tracking-tighter leading-[0.9] mb-8 mt-12 lg:mt-0">
        ...
        <section className="bg-primary text-surface grid place-content-center h-[100dvh] sticky top-0 z-50 rounded-t-3xl overflow-hidden shadow-[0_-10px_40px_rgba(0,0,0,0.2)] pb-20 lg:pb-0">
